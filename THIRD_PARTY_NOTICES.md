...
| Block attention residuals over depth | Attention Residuals (arXiv:2603.15031) | superseded here by Delta Block Attention Residuals, which routes per-block *changes* rather than accumulated state |
...
| Low-rank depth routing | arXiv:2607.09694 | no longer used. The earlier rank-64 routing key and its zero-gate identity initialisation were this project's; both were removed when Delta Block was adopted, since the published formulation scores at full width and has no gate. |
